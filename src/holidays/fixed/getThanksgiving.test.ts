...
describe("isThanksgivingDay", () => {
    it("should return true for Thanksgiving Day in NYC timezone", () => {
        ...
        expect(getThanksgiving(thanksgiving2025)).equal(HolidayStatus.CLOSED);
    });
    ...
    it("should handle leap years correctly", () => {
        ...
        expect(getThanksgiving(thanksgiving2024)).equal(HolidayStatus.CLOSED);
    });
    ...
    it("should return true for historical Thanksgiving dates", () => {
        ...
        expect(getThanksgiving(thanksgiving2000)).equal(HolidayStatus.CLOSED);
    });
    ...
    it("should handle times within the day and still return true", () => {
        ...
        expect(getThanksgiving(thanksgivingMorning)).equal(HolidayStatus.CLOSED);
        expect(getThanksgiving(thanksgivingEvening)).equal(HolidayStatus.CLOSED);
    });
});
